...
mod tests {
    ...
    fn connection_fields_change_connection_identity() {
        ...
        assert_ne!(node.connection_identity(), different_tls.connection_identity());
        assert_eq!(
            different_tls.connection_identity(),
            different_tls.clone().connection_identity()
        );
    }
