...
private let initializationResult: InitializationResult = {
    ...
    if (uniffi_cove_nfc_checksum_method_ndefrecordreader_id() != 26890) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_cove_nfc_checksum_method_ndefrecordreader_type_() != 36709) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_cove_nfc_checksum_constructor_ndefrecordreader_new() != 7649) {
        return InitializationResult.apiChecksumMismatch
    }
