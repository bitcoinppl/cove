        ...
        ScrollView {
            VStack(spacing: 30) {
                ...
                VStack(spacing: 20) {
                    ...
                    Text("The starting PIN is the 6 digit numeric PIN found of the back of your TAPSIGNER")
            ...
            .onChange(of: startingPin) { old, pin in
                ...
                if pin.count > 6, old.count < 6 {
                    return startingPin = old
                }

                if pin.count > 6 {
                    return startingPin = String(startingPin.prefix(6))
                }
            }
        }
