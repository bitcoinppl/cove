    ...
    var body: some View {
        SelectedWalletScrollReader(
            ...
            content: SelectedWalletPresentedContent(
                ...
                torStatusTitle: torStatusTitle,
                torStatusDetail: torStatusDetail,
...
private struct SelectedWalletPresentedContent: View {
    ...
    let tor: TorManager
    @Binding var showTorStatus: Bool
    ...
    let torStatusTitle: String
    let torStatusDetail: String?
    let torStatusColor: Color
...
private struct SelectedWalletToolbar: ToolbarContent {
            ...
            HStack(spacing: 5) {
                if tor.isEnabled {
                    ...
                    .popover(isPresented: $showTorStatus) {
                        TorStatusPopover(
                            title: torStatusTitle,
                            detail: torStatusDetail,
                            openSettings: openTorSettings
                        )
                    }
                }
    ...
    private func toggleTorStatus() {
        showTorStatus.toggle()
    }

    private func openTorSettings() {
        showTorStatus = false
...
private struct TorStatusPopover: View {
    let title: String
    let detail: String?
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 10) {
            Label(title, systemImage: "network.badge.shield.half.filled")
                .font(.headline)
            ...
            Button("Open Tor Settings", action: openSettings)
        }
        .padding()
