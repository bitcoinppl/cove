...
import org.bitcoinppl.cove.managers.WalletManager
import org.bitcoinppl.cove.views.FullPageLoadingView
import uniffi.cove_core.WalletId
import uniffi.cove_core.WordValidator
            ...
            if (verificationComplete) {
                ...
                HotWalletVerifyScreen(
                    ...
                    onSkip = {
                        ...
                        app.resetRoute(uniffi.cove_core.RouteFactory().selectedWallet(id))
                    },
                    correctWord = validator!!.correctWord(1u).lowercase(),
                    questionIndex = 1,
