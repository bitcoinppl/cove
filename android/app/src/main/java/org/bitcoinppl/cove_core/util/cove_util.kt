   ...
   internal fun setValue(other: RustBuffer) {
    ...
    companion object {
        internal fun alloc(size: ULong = 0UL) = uniffiRustCall() { status ->
            ...
            UniffiLib.ffi_cove_util_rustbuffer_alloc(size.toLong(), status)
        }.also {
            if(it.data == null) {
        ...
        internal fun free(buf: RustBuffer.ByValue) = uniffiRustCall() { status ->
            UniffiLib.ffi_cove_util_rustbuffer_free(buf, status)
        }
    }
...
internal object IntegrityCheckingUniffiLib {
    init {
        Native.register(IntegrityCheckingUniffiLib::class.java, findLibraryName(componentName = "cove_util"))
    ...
    external fun uniffi_cove_util_checksum_method_generationtracker_advance(
    ): Short
    external fun uniffi_cove_util_checksum_method_generationtracker_capture(
    ): Short
    external fun uniffi_cove_util_checksum_method_generationtracker_is_current(
    ): Short
    external fun uniffi_cove_util_checksum_constructor_generationtracker_new(
    ): Short
...
internal object UniffiLib {
    ...
    external fun ffi_cove_util_rust_future_cancel_u8(`handle`: Long,
    ): Unit
    ...
    external fun ffi_cove_util_rust_future_cancel_i8(`handle`: Long,
    ): Unit
    ...
    external fun ffi_cove_util_rust_future_cancel_u16(`handle`: Long,
    ): Unit
    ...
    external fun ffi_cove_util_rust_future_cancel_i16(`handle`: Long,
    ): Unit
    ...
    external fun ffi_cove_util_rust_future_cancel_u32(`handle`: Long,
    ): Unit
    ...
    external fun ffi_cove_util_rust_future_cancel_i32(`handle`: Long,
    ): Unit
    ...
    external fun ffi_cove_util_rust_future_cancel_u64(`handle`: Long,
    ): Unit
    ...
    external fun ffi_cove_util_rust_future_cancel_i64(`handle`: Long,
    ): Unit
    ...
    external fun ffi_cove_util_rust_future_cancel_f32(`handle`: Long,
    ): Unit
    ...
    external fun ffi_cove_util_rust_future_cancel_f64(`handle`: Long,
    ): Unit
    ...
    external fun ffi_cove_util_rust_future_cancel_rust_buffer(`handle`: Long,
    ): Unit
    ...
    external fun ffi_cove_util_rust_future_cancel_void(`handle`: Long,
    ): Unit
...
open class GenerationTracker: Disposable, AutoCloseable, GenerationTrackerInterface
{
    ...
    private class UniffiCleanAction(private val handle: Long) : Runnable {
        override fun run() {
            ...
            uniffiRustCall { status ->
                UniffiLib.uniffi_cove_util_fn_free_generationtracker(handle, status)
            }
        }
    }
    ...
    fun uniffiCloneHandle(): Long {
        ...
        return uniffiRustCall() { status ->
            UniffiLib.uniffi_cove_util_fn_clone_generationtracker(handle, status)
        }
    }

    override fun `advance`(): GenerationToken {
            return FfiConverterTypeGenerationToken.lift(
    callWithHandle {
    uniffiRustCall() { _status ->
    UniffiLib.uniffi_cove_util_fn_method_generationtracker_advance(
        it,
        _status)
}
    }
    ...
    callWithHandle {
    uniffiRustCall() { _status ->
    UniffiLib.uniffi_cove_util_fn_method_generationtracker_capture(
        it,
        _status)
}
    }
 ...
 * @suppress
 */
public object FfiConverterTypeGenerationTracker: FfiConverter<GenerationTracker, Long> {
    override fun lower(value: GenerationTracker): Long {
        return value.uniffiCloneHandle()
    }

    override fun lift(value: Long): GenerationTracker {
        return GenerationTracker(UniffiWithHandle, value)
    }

    override fun read(buf: ByteBuffer): GenerationTracker {
        return lift(buf.getLong())
    }

    override fun allocationSize(value: GenerationTracker) = 8UL

    override fun write(value: GenerationTracker, buf: ByteBuffer) {
 ...
 * @suppress
 */
public object FfiConverterTypeGenerationToken: FfiConverterRustBuffer<GenerationToken> {
    override fun read(buf: ByteBuffer): GenerationToken {
        return GenerationToken(
            FfiConverterULong.read(buf),
        )
    }

    override fun allocationSize(value: GenerationToken) = (
            FfiConverterULong.allocationSize(value.`value`)
    )

    override fun write(value: GenerationToken, buf: ByteBuffer) {
